About doepipeline-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/doepipeline-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2334&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/doepipeline-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `doepipeline` can be installed with `conda`:
...
```
mamba install doepipeline
```

It is possible to list all of the versions of `doepipeline` available on your platform with `conda`:
...
```
mamba search doepipeline --channel conda-forge
```
...
mamba repoquery search doepipeline --channel conda-forge

# List packages depending on `doepipeline`:
mamba repoquery whoneeds doepipeline --channel conda-forge

# List dependencies of `doepipeline`:
mamba repoquery depends doepipeline --channel conda-forge
```
